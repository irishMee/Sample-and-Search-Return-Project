...
class RoverState():
    def __init__(self):
        ...
        self.obs_angles = None # Angles of obstacles terrain pixels
        self.obs_dists = None # Distances of obstacles terrain pixels        
        self.ground_truth = ground_truth_3d # Ground truth worldmap
        self.mode = 'forward' # Current mode (can be forward or stop)
        self.throttle_set = 0.2 # orginal 0.2 Throttle setting when accelerating
